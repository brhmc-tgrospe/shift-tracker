export type ShiftType = 'free' | '8h' | '12h-m' | '12h-e' | 'off' | 'holiday' | 'on-leave' | 'N/A';
...
export const SHIFTS: Record<ShiftType, ShiftDefinition> = {
  ...
  '8h': { type: '8h', label: '8 Hours', colorClass: 'bg-emerald-100 dark:bg-emerald-900/40 hover:bg-emerald-200 dark:hover:bg-emerald-900/60 text-emerald-900 dark:text-emerald-100 border-emerald-200 dark:border-emerald-800', defaultHours: 8 },
